				...
				{/jstabs}
					...
					{if $gBitUser->hasPermission( 'p_fisheye_upload_nonimages' )}
						<div class="row">
							...
							{forminput}
								<input type="checkbox" id="process_archive" name="process_archive" value="false" checked="unchecked" />
								{formhelp note="If you want to have archived files processed and extracted, please check the above box."}
							{/forminput}
						</div>
					{else}
